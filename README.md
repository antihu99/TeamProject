...
# 📋 TODO 리스트
- [ ] certi column 추가에 따른 전체 TC 검토 및 보완
- [ ] certi column 추가 구현
- [ ] -p 출력 옵션 변경에 대한 TC 검토 및 보완
- [ ] -p 옵션 변경 구현
    - [ ] 변경 전 데이터 출력
    - [ ] 옵션 미적용시, record 수 출력
    - [ ] 출력 갯수 5개 제한, 없을 때 NONE 출력
- [ ] MOD 기능 TC 구현
- [ ] MOD 기능 구현
- [ ] 2옵션 이름, 성(-f, -l) TC 구현
- [ ] 2옵션 이름, 성(-f, -l) 기능 구현
- [ ] 2옵션 전화번호(-m, -l) TC 구현
- [ ] 2옵션 전화번호(-m, -l) 기능 구현
- [ ] 2옵션 생년월일(-y, -m, -d) TC 구현
- [ ] 2옵션 생년월일(-y, -m, -d) 기능 구현
- [ ] 3옵션 부등호(SCH만 -g, -ge, -s, -se) TC 구현
- [ ] 3옵션 부등호(SCH만 -g, -ge, -s, -se) 기능 구현
- [ ] and, or 연산 옵션 (2옵션, 3옵션) TC 구현
- [ ] and, or 연산 옵션 (2옵션, 3옵션) 기능 구현
- [ ] refactoring
